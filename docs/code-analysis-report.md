...
### P3-01 — Strings hardcodées en français (hors i18n) dans AdminDashboard
...
### P3-02 — Deux systèmes de toast coexistent
...
### P3-03 — `src/integrations/supabase/types.ts` potentiellement désynchronisé
...
### P3-04 — Scripts de seed sans validation d'environnement
