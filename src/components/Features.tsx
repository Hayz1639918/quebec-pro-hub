...
const Features = () => {
  ...
  return (
    <section className="relative py-24 sm:py-32 lg:py-40 overflow-hidden bg-[hsl(220,20%,8%)]">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-px bg-white/[0.06] mb-16 sm:mb-24">
          {features.map((feature, index) => {
            ...
            return (
              <div
                key={index}
                className="relative bg-[hsl(220,20%,8%)] p-8 sm:p-10 group hover:bg-white/[0.03] transition-colors duration-500"
              >
                <div className="flex items-start justify-between mb-8">
                  <div className="p-2.5 border border-white/8 bg-white/[0.03] group-hover:border-white/15 transition-all duration-500">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {[
            ...
            <div key={title} className="relative overflow-hidden group" style={{ aspectRatio: '4/3' }}>
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[hsl(220,20%,8%)] via-[hsl(220,20%,8%)]/20 to-transparent" />
