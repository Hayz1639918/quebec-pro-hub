    ...
    <section className="relative py-16 sm:py-20 lg:py-24 overflow-hidden bg-primary">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-10 sm:mb-14 max-w-3xl">
          <span className="font-mono text-[11px] text-white/65 uppercase tracking-[0.15em] block mb-4">
            Fonctionnalités
          </span>
          <h2 className="font-display text-white/90 leading-[1.02] mb-4">
            {t("features.title")}
          </h2>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-px bg-white/[0.06] mb-10 sm:mb-14">
          {features.map((feature, index) => {
            const Icon = feature.icon;
            return (
              <div
                key={index}
                className="relative bg-primary p-8 sm:p-10 group hover:bg-white/[0.03] transition-colors duration-500"
              >
