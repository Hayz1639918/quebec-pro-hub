...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-[6px] text-sm font-ui font-semibold tracking-wide transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-40 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:     "bg-primary text-primary-foreground hover:bg-primary-hover active:scale-[0.98] border border-primary/70 shadow-[0_14px_30px_-18px_hsl(var(--primary)/0.8)] hover:shadow-[0_18px_36px_-16px_hsl(var(--primary)/0.85)]",
        destructive: "bg-destructive text-destructive-foreground hover:bg-destructive/85 active:scale-[0.98]",
        outline:     "border border-border/90 text-foreground bg-card/70 hover:border-primary/60 hover:text-primary hover:bg-primary/8 active:scale-[0.98]",
        secondary:   "bg-secondary text-secondary-foreground border border-border/70 hover:bg-muted active:scale-[0.98]",
