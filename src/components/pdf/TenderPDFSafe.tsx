...
/**
 * Standard PDF fonts such as Helvetica only support a limited character set.
 * Project descriptions are user-generated, so normalize common typography and
 * remove unsupported glyphs before handing strings to PDFKit.
 */
...
const TenderPDFSafe: React.FC<TenderPDFProps> = ({ project, client }) => {
