    ...
    <section className="relative py-16 sm:py-20 lg:py-24 overflow-hidden bg-background">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-10 sm:mb-14 max-w-2xl mx-auto">
          ...
          <div className="h-px w-16 bg-foreground/12 mx-auto mb-4" />
        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto">
          ...
          {/* Client card — dark */}
          <div className="relative bg-primary p-8 sm:p-10 lg:p-12 group overflow-hidden hover:bg-primary-hover transition-colors duration-500">
            ...
            <div className="relative">
              ...
              <button
                className="w-full sm:w-auto inline-flex items-center justify-center gap-3 font-ui font-medium text-sm px-8 py-3.5 bg-white text-foreground hover:bg-slate-50 transition-all duration-300 rounded-full group/btn shadow-[0_0_32px_-8px_hsl(var(--primary)/0.4)]"
          ...
          <div className="relative bg-card border border-border p-8 sm:p-10 lg:p-12 group overflow-hidden hover:border-primary/15 transition-colors duration-500">
            ...
            <div className="relative">
              ...
              <button
                className="w-full sm:w-auto inline-flex items-center justify-center font-ui font-medium text-sm px-8 py-3.5 bg-primary text-white hover:bg-primary-hover transition-all duration-300 rounded-full"
                onClick={() => navigate("/auth?mode=signup")}
              >
